...
public class ScoreReceiverConsumer {
    ...
    public void orderReceiver(Message message, @Headers Map<String, Object> headers, Channel channel) throws Exception {
        try {
            ...
            //todo:根据不用的异常，然后判断是否需要再次重试
            //todo:设置伟true时候，需要重新发布接收，会再次接到消息,日志监控进行预警
